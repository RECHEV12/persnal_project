                        ...
                        <div class="row g-0">
                            <div class="">
                                <div class="p-5" id="cartBox">
                                    ...
                                    <div class="pt-5">
                                        <h6 class="mb-0"><a href="/cart/cart.wow?userId=${user.userId}"
                                                            class="text-body"><i
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div>
                                            ...
                                            <input id="userHp" class="form-control" name="userHp" type="text" value="${user.userHp}">
                                            <label for="userZip">
                                                우편번호
                                            </label>
                                            <input id="userZip"  class="form-control" name="userZip" type="text" value="${user.userZip}">
                                            <label for="userAddr1">
                                                주소 1
                                            </label>
                                            <input id="userAddr1"  class="form-control" name="userAdd1" type="text" value="${user.userAdd1}">
                                            <label for="userAddr2">
                                                주소 2
                                            </label>
                                            <input id="userAddr2"  class="form-control" name="userAdd2" type="text" value="${user.userAdd2}">
                                            <label for="userWant">
                                                남기실 말씀
                                            </label>
                                            <input id="userWant"  class="form-control" name="userWant" type="text" value="">
                                        </div>
                                        <hr class="my-4">
                                        <div class="text-end  mb-5">
                                            <h5 class="">Total price : <span id="totalPrice"></span></h5>
